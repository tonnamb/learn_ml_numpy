...
data:
	mkdir data
	curl https://www.clips.uantwerpen.be/conll2000/chunking/train.txt.gz --output data/conll_2000_chunking_train.txt.gz
	gunzip data/conll_2000_chunking_train.txt.gz
	curl https://www.clips.uantwerpen.be/conll2000/chunking/test.txt.gz --output data/conll_2000_chunking_test.txt.gz
